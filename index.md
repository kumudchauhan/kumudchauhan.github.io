...
<section class="hero">
  <div class="hero-container">
    ...
    <div class="hero-image">
      <img src="assets/kumud_profile.jpg" alt="Kumud Chauhan">
    </div>
  </div>
</section>
  ...
  <div class="section-container">
    ...
    <div class="capabilities-grid">
      <div class="capability-card reveal">
        ...
        <h3>ML Systems</h3>
        <p>Production-grade ML pipelines, from training to real-time serving at scale</p>
      </div>
      <div class="capability-card reveal">
        <span class="capability-icon">&#9998;</span>
        <h3>NLP &amp; LLMs</h3>
        <p>Document understanding, information extraction, transformer fine-tuning</p>
      </div>
      <div class="capability-card reveal">
        <span class="capability-icon">&#9776;</span>
